<?php
		...
		function show_objects_networkobjects($type, $section, $section2, $tablename)
		{
			...
			echo "   &nbsp;<a href=\"".$_SERVER['PHP_SELF']."?mainsection=t_objects&section=t_objects_overview\">..:: back ::..</a>&nbsp;\n";
			echo "  </td>\n";
			echo " </tr>\n";
			echo "</table>\n";*/
			...
			echo "   &nbsp;<br><a href=\"".$_SERVER['PHP_SELF']."?mainsection=t_objects&section=t_objects_item&subsection=".$section."&action=add\">..:: add entry ::..</a>&nbsp;\n";
			...
			switch ($type)
			{
				...
				case 0:
				{
					// echo "<TABLE cellSpacing=1 cellPadding=0 width=666 border=0>\n";
					// echo "<TBODY>\n";
					// echo "<TR class=tablehead bgColor=#565656>\n";
					// echo "<TD vAlign=bottom align=left width=\"226\" height=\"22\"><FONT color=#ffffff>&nbsp;".getDesc(10001)."</FONT>\n";
					// echo "<IMG height=6 src=\"./images/border_orange.gif\" width=\"226\" border=0></TD>\n";
					// echo "<TD vAlign=bottom align=left width=\"226\" height=\"22\"><FONT color=#ffffff>&nbsp;".getDesc(10002)."</FONT>\n";
					// echo "<IMG height=6 src=\"./images/border_orange.gif\" width=\"226\" border=0></TD>\n";
					// echo "<TD vAlign=bottom align=left width=\"120\" height=\"22\"><FONT color=#ffffff>&nbsp;".getDesc(10003)."</FONT>\n";
					// echo "<IMG height=6 src=\"./images/border_orange.gif\" width=\"120\" border=0></TD>\n";
					// echo "<TD vAlign=bottom align=left width=\"94\" height=\"22\"><FONT color=#ffffff>&nbsp;".getDesc(10004)."</FONT>\n";
					...
					echo "<IMG height=6 src=\"./images/border_orange.gif\" width=\"226\" border=0></TD>\n";
					echo "<TD vAlign=bottom align=left width=\"226\" height=\"22\"><FONT color=#ffffff>&nbsp;NOTE</FONT>\n";
					echo "<IMG height=6 src=\"./images/border_orange.gif\" width=\"226\" border=0></TD>\n";
					...
					for ($i=0; $i < $number; $i++)
					{
						...
						echo "&nbsp;<a href=\"".$_SERVER['PHP_SELF']."?module=".$section."&action=edit&sid=".$row['id']."\"><IMG SRC=\"./images/icons/edit_gr.gif\" WIDTH=\"22\" HEIGHT=\"16\" BORDER=0 ALT=\"edit\"></a>\n";
						echo "<a href=\"".$_SERVER['PHP_SELF']."?module=".$section."&action=delete&sid=".$row['id']."&sd_override=no\"><IMG SRC=\"./images/icons/delete.gif\" WIDTH=\"16\" HEIGHT=\"16\" BORDER=0 ALT=\"delete\"></a>&nbsp;</TD>\n";
						echo "</TR>\n";
					...
					echo "						<TD vAlign=bottom align=middle height=20>&nbsp;<a href=\"".$_SERVER['PHP_SELF']."?module=".$section."&action=add\"><IMG SRC=\"./images/add_entry_gr.gif\" WIDTH=\"50\" HEIGHT=\"16\" BORDER=0 ALT=\"add entry\"></a>&nbsp;</TD>\n";
					echo "					</TR>\n";
					echo "					</table>\n";
					echo "					</tbody>\n";
					echo "				</td>\n";
				...
				case 1:
				{
					...
					for ($i=0; $i < $number; $i++)
					{
						...
						echo "&nbsp;<a href=\"".$_SERVER['PHP_SELF']."?module=".$section."&action=edit&sid=".$row['id']."\"><IMG SRC=\"images/icons/edit_gr.gif\" WIDTH=\"22\" HEIGHT=\"16\" BORDER=0 ALT=\"edit\"></a>\n";
						echo "<a href=\"".$_SERVER['PHP_SELF']."?module=".$section."&action=delete&sid=".$row['id']."\"><IMG SRC=\"images/icons/delete.gif\" WIDTH=\"16\" HEIGHT=\"16\" BORDER=0 ALT=\"delete\"></a>&nbsp;</TD>\n";
						echo "</TR>\n";
					}
				...
				case 2:
				{
					...
					for ($i=0; $i < $number; $i++)
					{
						...
						echo "   </td>\n";
						echo "   <td align=\"left\">\n";
						echo "    <a href=\"".$_SERVER['PHP_SELF']."?module=".$section."&action=edit&sid=".$row['id']."\">edit</a>&nbsp;<a href=\"".$_SERVER['PHP_SELF']."?module=".$section."&action=delete&sid=".$row['id']."\">delete</a>\n";
						echo "   </td>\n";
						echo "  </tr>\n";
					}
				...
				case 3:
				{
					...
					for ($i=0; $i < $number; $i++)
					{
						...
						echo "   </td>\n";
						echo "   <td align=\"left\">\n";
						echo "    <a href=\"".$_SERVER['PHP_SELF']."?module=".$section."&action=edit&sid=".$row['id']."\">edit</a>&nbsp;<a href=\"".$_SERVER['PHP_SELF']."?module=".$section."&action=modify&sid=".$row['id']."\">modify</a>&nbsp;<a href=\"".$_SERVER['PHP_SELF']."?module=".$section."&action=delete&sid=".$row['id']."\">delete</a>\n";
						echo "   </td>\n";
						echo "  </tr>\n";
					}
		...
		function edit_objects_networkobjects($type, $section, $section2, $tablename, $id, $status)
		{
		    ...
		    if (!isset($status))
		    {
				...
				echo "		<form method=\"post\" action=\"".$_SERVER['PHP_SELF']."?module=".$section."&action=edit\" name=\"submitform\">";
				echo "		<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">\n";
				echo "			<tr>\n";
				echo "				<td height=\"20px\" colspan=\"2\">\n";
				echo "					<img src=\"./images/tpx.gif\" id=\"blank\" border=\"0\" width=\"1px\" height=\"20px\"></td>\n";
				...
				switch ($type)
				{
					...
					case 0:
					{
						...
						echo "<a href=\"javascript:document.submitform.reset()\"><img src=\"./images/reset.gif\" border=\"0\"></a>&nbsp;\n";
    					        echo "<a href=\"".$_SERVER['PHP_SELF']."?module=hosts\"><img src=\"./images/icons/cancel.gif\" border=\"0\"></a>&nbsp;\n";
						echo "</TD>\n";
						echo "</TR>\n";
			...
			elseif (substr($status,0,5) == 'error')
			{
				...
				switch ($type)
				{
					case 0:
					{
						...
						echo "<a href=\"javascript:document.submitform.submit()\"><img src=\"./images/change.gif\" border=\"0\"></a>&nbsp;\n";
						echo "<a href=\"javascript:document.submitform.reset()\"><img src=\"./images/reset.gif\" border=\"0\"></a>&nbsp;\n";
						echo "<a href=\"".$_SERVER['PHP_SELF']."?module=hosts\"><img src=\"./images/icons/cancel.gif\" border=\"0\">&nbsp;\n";
						echo "</TD>\n";
						echo "</TR>\n";
					...
					case 1:
					{
						...
						echo "<a href=\"javascript:document.submitform.submit()\"><img src=\"./images/change.gif\" border=\"0\"></a>&nbsp;\n";
						echo "<a href=\"javascript:document.submitform.reset()\"><img src=\"./images/reset.gif\" border=\"0\"></a>&nbsp;\n";
    					        echo "<a href=\"".$_SERVER['PHP_SELF']."?module=networks\"><img src=\"./images/icons/cancel.gif\" border=\"0\"></a>&nbsp;\n";
						echo "</TD>\n";
						echo "</TR>\n";
				...
				switch ($type)
				{
					...
					case 1:
					{
						...
						else
						{
							...
							if (ip_address_check($networkip, $tablename, "networkip") == true)
							{
								$field2 = "jonip";
							}
							
							if (netmask_check($networkmask, $tablename, "networkmask") == true)
							{
								$field3 = "jonmask";
							}
				...
				switch ($type)
				{
					...
					case 1:
					{
						...
						else
						{
							...
							if ((checkhostname($_POST['hostname'], "", $tablename) == true) and (!empty($_POST['hostname'])))
							{
								$field1 = "joho";
							}
							
							if (ip_address_check($_POST['networkip'], $tablename, "networkip") == true)
							{
								$field2 = "jonip";
							}
							
							if (netmask_check($_POST['networkmask'], $tablename, "networkmask") == true)
							{
								$field3 = "jonmask";
							}
