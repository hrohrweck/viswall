...
<tr valign="top">
	...
	<td align="left" height="23px" bgcolor="#E2E3DF">STRATEGY | <B>DANSGUARDIAN</B> (1) &nbsp;</td>
	<td align="left" height="23px" bgcolor="#E2E3DF"><img src="./images/tpx.gif" width="200px" height="23px" border="0"></td>
</tr>
</table>
<CENTER>
<iframe src="https://<?=$_SERVER[SERVER_NAME];?>:10000/dansguardian" name="dansguardian" id="dansguardian" width="990" height="450" ALLOWTRANSPARENCY="true" frameborder=0></iframe>
<br><a href="#" onclick="javascript:dansguardian.location.href='https://<?=$_SERVER[SERVER_NAME];?>:10000/dansguardian';">Back</a>
</CENTER>
<?php
		}
		else
