...
<tr valign="top">
	...
	<td align="left" height="23px" bgcolor="#E2E3DF">LOG | <B>SYSLOG</B> &nbsp;</td>
	<td align="left" height="23px" bgcolor="#E2E3DF"><img src="./images/tpx.gif" width="200px" height="23px" border="0"></td>
</tr>
</table>
<CENTER>
<iframe src="https://<?=$_SERVER[SERVER_NAME];?>:10000/syslog" name="syslog" id="syslog" width="990" height="450" ALLOWTRANSPARENCY="true" frameborder=0></iframe>
</object>
<br><a href="#" onclick="javascript:syslog.location.href='https://<?=$_SERVER[SERVER_NAME];?>:10000/syslog';">Back</a>
</CENTER>
<?php
		}
		else
